...
<div class="container max-w-full mx-auto py-14 px-6">
  <div class="font-sans">
    ...
    <div class="relative flex flex-wrap">
      <div class="w-full relative">
        <div class="mt-6">
           ...
           <span>By <a class="text-blue-500" href="#">@Jake</a></span>
          </div>
          <div class="text-center font-semibold text-black">
            
          </div>
         
          <form class="mt-8" action="/process" method="post">
            @csrf
            <div class="mx-auto max-w-lg">
              ...
              <div class="flex justify-between"><label class="block text-gray-500 font-bold my-4"><input type="checkbox"
                ...
                Login
                 ...
                 @error('kkk')
                <p class="text-red-500 text-xl mt-5 text-center">{{ $message }}</p>
                @enderror

                <label class="block text-gray-500 font-bold my-6 text-center">  
                  <a href="/register" class="cursor-pointer tracking-tighter text-blue-500 border-b-2 border-gray-200 hover:border-gray-400"><span>Create your account?</span></a>
              </label>
